...
return [
    ...
    */
    ...
    'accepted' => ' :attribute هذا الحقل يجب قبوله.',
    'accepted_if' => ':attribute هذا الحقل يجب قبوله عندما :other is :value.',
    'active_url' => ' :attribute field must be a valid URL.',
    'after' => ' :attribute هذا الحقل يجب ان يكون بعد تاريخ :date.',
    ...
    'decimal' => ' :attribute يجب ان يحتوي الحقل على :decimal decimal places.',
    ...
    'required_array_keys' => ' :attribute يجب أن يحتوي الحقل على إدخالات لـ: :values.',
    'required_if' => ' :attribute الحقل مطلوب عندما when :other is :value.',
    'required_if_accepted' => ' :attribute الحقل مطلوب عندما:other is accepted.',
    'required_if_declined' => ':attribute الحقل مطلوب عندما:other is declined.',
    'required_unless' => ' :attribute الحقل مطلوب ما لم :other is in :values.',
    ...
    'required_without' => ' :attribute الحقل مطلوب عندما :values is not present.',
    'required_without_all' => ' :attribute الحقل مطلوب عندما none of :values are present.',
    'same' => ' :attribute يجب ان يتشابه الحقل مع :other.',
    'size' => [
        'array' => ' :attribute يجب ان يحتوي الحقل على :size items.',
        'file' => ' :attribute يجب ان يكون الحقل :size kilobytes.',
        'numeric' => ' :attribute يجب ان يكون حجم الحقل :size.',
        'string' => ' :attribute يجب ان يكون الحقل :size characters.',
    ],
